...
class HelpCommand(commands.HelpCommand):
    ...
    async def send_bot_help(self, _):
        ...
        embed = discord.Embed(color=0xFD8063)
        ...
        for command in filtered:
            ...
            if command.name == "help":
                ...
                embed.add_field(name=f'!{command.name} {command.signature}', value=value, inline=False)
...
description = """
Hello. I am a discord bot written by BMan#0001 to provide a mutli-purpose utility/moderation service to multiple servers.
"""
